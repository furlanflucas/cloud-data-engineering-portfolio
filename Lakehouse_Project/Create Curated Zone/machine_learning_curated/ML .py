...
'''
SQLQuery_node1738179455512 = sparkSqlQuery(glueContext, query = SqlQuery5465, mapping = {"accelerometer_trusted":accelerometer_trusted_node1738179427815, "step_training_trusted":step_training_trusted_node1738179443246}, transformation_ctx = "SQLQuery_node1738179455512")
...
AmazonS3_node1738179731984 = glueContext.write_dynamic_frame.from_options(frame=SQLQuery_node1738179455512, connection_type="s3", format="glueparquet", connection_options={"path": "s3://step-trainer--bucket/machine_learning_curated/", "partitionKeys": []}, format_options={"compression": "snappy"}, transformation_ctx="AmazonS3_node1738179731984")
